...
//        }
    ...
    public static byte[] removeElements(final byte[] array, final byte... values) {
        ...
        final java.util.Map<Byte, MutableInt> occurrences = new HashMap<>(values.length);
     ...
     */
    public static java.util.Map<Object, Object> toMap(final Object[] array) {
        if (array == null) {
            return null;
        }
        final java.util.Map<Object, Object> map = new HashMap<>((int) (array.length * 1.5));
        for (int i = 0; i < array.length; i++) {
            final Object object = array[i];
            if (object instanceof java.util.Map.Entry<?, ?>) {
                final java.util.Map.Entry<?, ?> entry = (Map.Entry<?, ?>) object;
